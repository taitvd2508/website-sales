...
<head>
    <title>Tai Store - Product Listing Page</title>
    <meta charset="utf-8">
			...
			<div class="col-lg-9">
                ...
                <div class="row"> <!-- button page -->
                    ...
                    <ul class="col-6 pagination pagination-lg justify-content-center">
                        <li class="page-item">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark" href="/home/shop?p=0" tabindex="-1"><i class="fas fa-angle-double-left"></i></a>
                        </li>
                        <li class="page-item">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark ${page.number == 0 ? 'disabled_a text-muted' : ''}" href="/home/shop?p=${page.number-1}"><i class="fas fa-angle-left"></i></a> <!-- Nếu page.number = 0 : tức là trang đầu thì vô hiệu hóa nút  -->
                        </li>
           				<!-- LẶP SỐ TRANG -->
                        ...
                        <li class="page-item">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 fw-bold text-dark ${page.number == sotrang-1 ? 'active text-white' : ''}" href="/home/shop?p=${sotrang-1}">${sotrang}</a>   
                        </li>
                        </c:forEach>          
                        <li class="page-item">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark ${page.number == page.totalPages-1 ? 'disabled_a text-muted' : ''}" href="/home/shop?p=${page.number+1}"><i class="fas fa-angle-right"></i></a> <!-- Nếu page.number = trang cuối : tức là trang cuối thì vô hiệu hóa nút  -->
                        </li>
                        <li class="page-item">
