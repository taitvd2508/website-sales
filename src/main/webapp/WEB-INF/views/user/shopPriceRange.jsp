...
<head>
    <title>Tai Store - Shop Price Range</title>
    <meta charset="utf-8">
				...
				<ul class="list-unstyled templatemo-accordion">
                    ...
                    <li class="pb-3">
                    	<div class="wrapper">
							...
							<form action="/home/shop/price" method="POST">
			...
			<div class="col-lg-9">
                ...
                <div class="row"> <!-- button page -->
                    ...
                    <ul class="col-6 pagination pagination-lg justify-content-center">
                        <li class="page-item">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark" href="/home/shop/price?min=${min}&max=${max}&p=0" tabindex="-1"><i class="fas fa-angle-double-left"></i></a>
                        </li>
                        <li class="page-item">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark ${page.number == 0 ? 'disabled_a text-muted' : ''}" href="/home/shop/price?min=${min}&max=${max}&p=${page.number-1}"><i class="fas fa-angle-left"></i></a> <!-- Nếu page.number = 0 : tức là trang đầu thì vô hiệu hóa nút  -->
                        </li>
           				<!-- LẶP SỐ TRANG -->
           				<c:forEach var="sotrang" begin="${first >= page.totalPages - 3 ? page.totalPages - 3 >= 1 ? page.totalPages - 3 : 1 : first}" end="${end >= page.totalPages ? page.totalPages : end}">
                        <li class="page-item">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 fw-bold text-dark ${page.number == sotrang-1 ? 'active text-white' : ''}" href="/home/shop/price?min=${min}&max=${max}&p=${sotrang-1}">${sotrang}</a>   
                        </li>
                        </c:forEach>
                        <li class="page-item">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark ${page.number == page.totalPages-1 ? 'disabled_a text-muted' : ''}" href="/home/shop/price?min=${min}&max=${max}&p=${page.number+1}"><i class="fas fa-angle-right"></i></a> <!-- Nếu page.number = trang cuối : tức là trang cuối thì vô hiệu hóa nút  -->
                        </li>
                        <li class="page-item">
                            <a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark" href="/home/shop/price?min=${min}&max=${max}&p=${page.totalPages-1}"><i class="fas fa-angle-double-right"></i></a>
                        </li>
                    </ul>
                </div> <!-- end button page -->
            </div>
        ...
        <div class="container my-4">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <h1 class="fw-bold">Our Brands</h1>
                    <p>
