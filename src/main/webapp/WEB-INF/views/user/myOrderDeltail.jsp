...
<head>
    <title>Tai Store - My OrderDetail</title>
    <meta charset="utf-8">
...
<body>
	...
	<div class="row"> <!-- button page -->
    	<ul class="pagination pagination-lg justify-content-center">
            ...
            <li class="page-item">
            	<a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark ${page.number == 0 ? 'disabled_a text-muted' : ''}" href="/home/myOrderdetail?orderID=${order.id}&p=${page.number-1}"><i class="fas fa-angle-left"></i></a> <!-- Nếu page.number = 0 : tức là trang đầu thì vô hiệu hóa nút  -->
            </li>
           	<!-- LẶP SỐ TRANG -->
            ...
            <li class="page-item">
            	<a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark ${page.number == page.totalPages-1 ? 'disabled_a text-muted' : ''}" href="/home/myOrderdetail?orderID=${order.id}&p=${page.number+1}"><i class="fas fa-angle-right"></i></a> <!-- Nếu page.number = trang cuối : tức là trang cuối thì vô hiệu hóa nút  -->
            </li>
            <li class="page-item">
