    ...
    <nav class="sticky-top navbar navbar-expand-lg bg-dark navbar-light d-none d-lg-block h3" id="templatemo_nav_top">
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    <a class="navbar-sm-brand text-light fw-bold text-decoration-none btn" href="mailto:taitvdps20669@fpt.edu.vn"><i class="fa fa-envelope mx-2"></i> taitvdps20669@fpt.edu.vn</a>
                    <a class="navbar-sm-brand text-light fw-bold text-decoration-none btn" href="tel:taitvdps20669@fpt.edu.vn"><i class="fa fa-phone mx-2"></i> 0348 720 610</a>
                </div>
